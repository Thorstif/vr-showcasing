...
public class OVRGazePointer : MonoBehaviour {
	...
	void Update () {
        ...
        transform.position = cameraRig.rightHandAnchor.GetChild(0).transform.position + cameraRig.rightHandAnchor.GetChild(0).transform.forward * depth;
    ...
    public void SetPosition(Vector3 pos, Vector3 normal)
    {
        ...
        depth = (cameraRig.rightHandAnchor.GetChild(0).transform.position - pos).magnitude;
    ...
    {
        SetPosition(pos, cameraRig.rightHandAnchor.GetChild(0).transform.forward);
    }
    ...
    void LateUpdate()
    {
        ...
        if (positionSetsThisFrame == 0)
        {
            ...
            Quaternion newRot = transform.rotation;
            newRot.SetLookRotation(cameraRig.rightHandAnchor.GetChild(0).transform.forward, (lastPosition - transform.position).normalized);
            transform.rotation = newRot;
        }
